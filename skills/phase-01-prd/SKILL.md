...
trigger-words: prd, PRD, vision, product spec, what to build
phase: 01
...
# Phase 01: PRD (Product Requirements Document)
...
- (DELTA mode) `docs/spec/01-prd.md` (기존 버전)
...
DELTA mode에서는 `docs/spec/01-prd.md` 그대로 두고 proposal만 추가. 사용자 승인 후 구현 확정 시 spec에 머지.
